...
export async function POST(request: Request) {
  try {
    ...
    if (!process.env.EMAIL_SERVER || !process.env.EMAIL_FROM || !process.env.NEXTAUTH_URL) throw new ApiError('Email recovery is not available yet. Please contact hello@money-mirror.com for help.', 503)
