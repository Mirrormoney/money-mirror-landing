...
const dict = {
  en: {
    ...
    hero_sub: 'MirrorMoney turns past purchases into a risk-free, “what-if” portfolio—so you learn investing by reflection, not regret.',
    ...
    faq_a1: 'A learning tool that models how your past spending might have grown if invested, so you can build better habits before moving to real investing.',
    faq_q2: 'Do you need my bank login?',
    faq_a2: 'For the demo: no. Later, we’ll support secure read-only connections via regulated providers. You can also upload a CSV.',
    ...
    faq_a4: 'We offer a Premium plan with advanced features. When you’re ready to invest for real, we may earn referral fees from partner brokers.',
    demo_title: 'Interactive demo',
    demo_desc: 'This demo uses mock data. Adjust the “growth” slider below to see how a shadow portfolio might look without risking real money.',
    back: '← Back',
  ...
  de: {
    ...
    hero_sub: 'MirrorMoney verwandelt vergangene Käufe in ein risikofreies „What-if“-Portfolio – so lernst du Investieren durch Reflexion statt Reue.',
    ...
    hiw_1_body: 'Konto sicher verknüpfen (oder CSV hochladen). Wir lesen nur Transaktionen – mit deiner Zustimmung.',
    ...
    hiw_3_body: 'Sieh, wie dein Schatten-Portfolio wächst – und entscheide später, ob/wann du wirklich investieren willst.',
    ...
    faq_a1: 'Ein Lern-Tool, das zeigt, wie sich vergangene Ausgaben entwickelt hätten, wenn du investiert hättest – für bessere Gewohnheiten vor dem echten Investieren.',
    faq_q2: 'Braucht ihr mein Bank-Login?',
    faq_a2: 'Für die Demo: nein. Später ermöglichen wir sichere, schreibgeschützte Verbindungen über regulierte Anbieter. CSV-Upload ist möglich.',
    ...
    faq_a4: 'Über einen Premium-Plan mit Zusatzfunktionen. Wenn du später wirklich investierst, können wir Vermittlungsgebühren erhalten.',
